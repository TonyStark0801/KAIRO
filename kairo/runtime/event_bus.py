...
class GestureType(Enum):
    ...
    WAKE_TIMEOUT = auto()
    DOUBLE_CLAP = WAKE_WORD_DETECTED  # backward compat alias
...
class ActivityType(Enum):
    """Semantic classification of what the user is currently doing (Phase 2)."""
...
class ContextChangedEvent:
    """Emitted when the active app/window/browser tab changes (Phase 2)."""
...
class ClipboardChangedEvent:
    """Emitted when the system clipboard content changes (Phase 2)."""

    content: str          # capped at 500 chars
    content_type: str     # "url" | "code" | "text"
    timestamp: float
