...
PLIST_TEMPLATE="$SCRIPT_DIR/com.kairo.runtime.plist"
LABEL="com.kairo.runtime"
...
echo "Installing Kairo launchd agent..."
echo "  User:       $CURRENT_USER"
echo "  Python:     $PYTHON_PATH"
echo "  Project:    $PROJECT_DIR"
echo "  Plist:      $PLIST_DEST"

mkdir -p "$HOME_DIR/.kairo"
...
echo "Kairo daemon installed and started."
echo "  Stop:   launchctl unload $PLIST_DEST"
echo "  Start:  launchctl load $PLIST_DEST"
echo "  Logs:   $HOME_DIR/.kairo/"
